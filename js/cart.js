document.addEventListener("DOMContentLoaded", function () {
  ...
  function addProducts(arr) {
    ...
    productContainer.innerHTML = `
      ...
      <div class="col"><input type="number" class="form-control w-50 m-auto contador" min="1" max="100" value="${arr.count}"> <br></div>
      <div class="col" id="total-${arr.id}">${arr.currency}-${arr.unitCost*arr.count}</div>
